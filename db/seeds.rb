...
Resume.create!(
    ...
    years_of_experience: "5 plus year working with all of those programing languages",
...
Resume.create!(
  ...
  years_of_experience: "10 plus years working daily with all of those languages since i got out of school",
